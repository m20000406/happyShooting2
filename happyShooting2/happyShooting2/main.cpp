...
HWND g_hWnd;   //ウィンドウのhwnd
TCHAR szClassName[] = TEXT("happy shooting 2");    // ウィンドウクラス
...
BOOL InitInstance(HINSTANCE hInst, int nCmdShow)
{
	...
	g_hWnd = CreateWindow(szClassName, // クラス名
		TEXT("Happy Shooting 2"),
		// ウィンドウ名
		WS_OVERLAPPEDWINDOW,     // ウィンドウスタイル
		(rect.right-WIDTH)/2,           // x位置
		(rect.bottom-HEIGHT)/2,           // y位置
		WIDTH,           // ウィンドウ幅
		HEIGHT,           // ウィンドウ高さ
